...
SCHEMAS = {
    "TrustConnectionV1": s("TrustConnectionV1", {
        ...
        "state": {"type": "string", "enum": [
            "proposed", "negotiating", "active", "degraded", "suspended", 
            "terminating", "terminated", "rejected", "revoked", "expired", "failed"
        ]},
        "schema_version": STR,
        "policy_version": STR,
        "participants": {"type": "array", "items": {"$ref": "ConnectionParticipantV1.schema.json"}},
        "provider_identity": OPT_STR,
        "target_resource_id": OPT_STR,
        "target_resource_kind": OPT_STR,
        "capability_set_id": OPT_STR,
        "capability_set_version": OPT_STR,
        "condition_set_version": OPT_STR,
        "measurement_profile_id": OPT_STR,
        "settlement_profile_id": OPT_STR,
        "activation_evidence_hash": OPT_STR,
        "latest_transition_id": OPT_STR,
        "created_at": DT,
        "updated_at": DT,
    ...
    "ConnectionCapabilityPresentationV1": s("ConnectionCapabilityPresentationV1", {
        "presentation_id": STR,
        "connection_id": STR,
        "capability_id": STR,
        "granted_by": STR,
    }, desc="Proves a connection-scoped grant or delegation."),
    "CAPPOExecutionAuthorizationReferenceV1": s("CAPPOExecutionAuthorizationReferenceV1", {
        "authorization_id": STR,
        "execution_id": STR,
        "operation_hash": STR,
        "issued_by": STR,
    }, desc="Only CAPPO may issue the exact-operation execution authorization token used for consequential Lane 3 execution."),
    ...
    "OperationResultV1": s("OperationResultV1", {
        ...
        "execution_id": STR,
        "state": {"type": "string", "enum": [
            "requested", "validating", "held", "authorized", "executing",
            "waiting_event", "waiting_payment", "attesting", "settling", 
            "sealed", "failed", "quarantined", "cancelled", "compensating"
        ]},
        "lane": LANE,
        "result_hash": OPT_STR,
        "error_code": OPT_STR,
    ...
    "RouteSnapshotV1": s("RouteSnapshotV1", {
        ...
        "connection_id": STR,
        "connection_version": STR,
        "target_resource_binding": OPT_STR,
    ...
    "ApprovalReceiptV1": s("ApprovalReceiptV1", {
        ...
        "approval_decision": {"type": "string", "enum": ["allow", "hold", "deny", "quarantine", "require_approval"]},
        "approval_scope": STR,
        "approved_at": DT,
        "expires_at": DT,
        "single_use_identifier": STR,
        "signature_key_id": STR,
        "signature": STR,
